...
\begin{enumerate}
	...
	\item Given $n \in \mathbb{N}$, find a capacity function for the netweork below such that the algorithm from the proof of the max-flow min-cut theorem (aka Ford-Fulkerson Theorem) will need more than $n$ augmenting paths if the algorithm consistently chooses the path badly.	\\
